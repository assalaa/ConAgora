import 'package:conagora/Pages/detailsPage/details_page.dart';
...
class DishItemViewData {
  ...
  DishItemViewData.fromDish(Dish dish)
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => DetailsPage(dish.dishName!,
                        dish.dishDescription!, dish.dishPrice.toString())));
          },
          child: Card(
              elevation: 6,
